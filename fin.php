...
<!-- ################################################################################################ -->
<!-- ################################################################################################ -->
<div class="wrapper bgded overlay" style="background-image:url('images/demo/backgrounds/books_0.jpg');">
  <div id="pageintro" class="hoc clear"> 
    <!-- ################################################################################################ -->
    <article>
      <p>a smarter way of handling books online</p>
      <h3 class="heading">LIBRARY MANAGEMENT SYSTEM</h3>
      <p>An online website for managing the books through a smarter and reliable way.</p>
      <footer>
        <ul class="nospace inline pushright">
          <li><a class="btn" href="librarian_login.php">LIBRARIAN</a></li>
          <li><a class="btn inverse" href="student_login.php">STUDENTS</a></li>
        </ul>
      </footer>
    </article>
    <!-- ################################################################################################ -->
