...
<html lang="">
<head>
<title>LIBRARY MANAGEMENT SYSTEM | Pages | Gallery</title>
<meta charset="utf-8">
...
<div class="wrapper row1">
  <header id="header" class="hoc clear"> 
    ...
    <div id="logo" class="fl_left">
      ...
      <p>for those who want to learn</p>
    </div>
  ...
  <nav id="mainav" class="hoc clear"> 
    ...
    <ul class="clear">
      ...
      <li><a class="drop" href="#">ISSUED BOOKS</a>
        
      </li>
      <li><a class="drop" href="#">AVAILABLE BOOKS</a>
        <ul><li><a class="drop" href="#">1ST YEAR</a>
            <ul>
...
<li><a class="drop" href="#">2ND YEAR</a>
            <ul>
              <li><a href="#">BOOKS</a></li>
              <li><a href="#">CLASS NOTES</a></li>
              <li><a href="#">QUESTION PAPERS</a></li>
...
<li><a class="drop" href="#">3RD YEAR</a>
            <ul>
              <li><a href="#">BOOKS</a></li>
              <li><a href="#">CLASS NOTES</a></li>
              <li><a href="#">QUESTION PAPERS</a></li>
...
<li><a class="drop" href="#">4TH YEAR</a>
            <ul>
              <li><a href="#">BOOKS</a></li>
              <li><a href="#">CLASS NOTES</a></li>
              <li><a href="#">QUESTION PAPERS</a></li>
...
<!-- ################################################################################################ -->
<!-- ################################################################################################ -->
<div class="wrapper bgded overlay" style="background-image:url('l1.jpg');">
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      ...
      <div id="gallery">
        <figure>
          <header class="heading">SOME RECOMMENDED BOOKS</header>
